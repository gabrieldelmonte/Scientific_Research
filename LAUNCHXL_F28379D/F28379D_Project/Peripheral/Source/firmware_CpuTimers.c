/*======================================================================================================================
                                                         Cpu Timers                                                     |
                                                       --------------                                                   |
FILE: firmware_CpuTimers.c                                                                                              |
                                                                                                                        |
    Baseado em:                                                                                                         |
        "CPU 32-bit Timers Initialization & Support Functions"                                                          |
...
________________________________________________________________________________________________________________________|
     ...
     NOTES:   CpuTimer2 is reserved for use with DSP BIOS and other realtime operating systems.                         |
                                                                                                                        |
          Do not use these this timer in your application if you ever plan on integrating                               |
...
//---------------------------------------------------------------------------
// SetWatchdogInterruption:
//---------------------------------------------------------------------------
//      Salva na Vect Table o endere�o da interrup��o que vai ser executada quando
//    o watchdog for acionado.

//void SetTIMER_InterruptFunc(PINT function){
//
//    EALLOW;                                             //  Permite escrita em registradores protegidos
//        PieVectTable.TIMER0_INT = function;//  Seleciona fun��o 'cpu_timer0_isr' para ser executada quando a interrup��o TINT0 for chamada
