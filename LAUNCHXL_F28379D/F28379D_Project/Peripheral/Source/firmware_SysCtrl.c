/*======================================================================================================================
                                                ...
                                                -------------------------------                                         |
FILE: firmware_SysCtrl.c                                                                                                |
                                                                                                                        |
    Baseado em:                                                                                                         |
        "Device System Control Initialization & Support Functions"                                                      |
...
________________________________________________________________________________________________________________________|
 ...
 This section will then be mapped to a load and run address using the linker cmd file.                                  |
                                                                                                                        |
 Para DSP F28379D:  *IMPORTANT*                                                                                         |
