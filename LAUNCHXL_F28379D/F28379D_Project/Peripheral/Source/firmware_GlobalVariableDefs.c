/*======================================================================================================================
                                                      Global Variables                                                  |
                                                     ------------------                                                 |
FILE: firmware_GlobalVariableDefs.c                                                                                     |
                                                                                                                        |
    Baseado em:                                                                                                         |
        "DSP2833x Global Variables and Data Section Pragmas"                                                            |
...
#include "Libraries/Headers/F2837xD_device.h"     // F2837xD Headerfile Include File
