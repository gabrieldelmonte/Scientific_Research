...
UNION run = PIEVECTTABLE
{
   ...
   AdcaResultFile         	  : > ADCARESULT, type=NOINIT
   AdcbResultFile    	      : > ADCBRESULT, type=NOINIT
   AdccResultFile      		  : > ADCCRESULT, type=NOINIT
   AdcdResultFile         	  : > ADCDRESULT, type=NOINIT
   ...
   DcsmZ1OtpFile              : > DCSMZ1, type=DSECT
   DcsmZ2OtpFile              : > DCSMZ2, type=DSECT
   ...
   Cla1SoftIntRegsFile		  : > PIECTRL, type=DSECT
   //
